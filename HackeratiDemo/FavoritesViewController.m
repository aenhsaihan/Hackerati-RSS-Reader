...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        EntryEntity *entityEntity = [self.fetchedResultsController.fetchedObjects objectAtIndex:indexPath.row];
        [self.appDelegate.managedObjectContext deleteObject:entityEntity];
        
        NSError *error;
        
        if (![self.appDelegate.managedObjectContext save:&error]) {
            
            NSLog(@"Error: %@", ([error localizedDescription] != nil) ? [error localizedDescription] : @"Unknown Error");
...
-(void)performFetch
{
    self.appDelegate = [[IODAppDelegate alloc] init];
